using System;
using static CopperDevs.Core.Logger.AnsiColors;
...
namespace CopperDevs.Core.Logger
{
    ...
    public static class CopperLogger
    {
        ...
        internal static void LogMessage(Names colorName, Names backgroundColorName, string prefix, object message)
        {
            var color = GetColor(colorName);
            var backgroundColor = GetBackgroundColor(backgroundColorName);
